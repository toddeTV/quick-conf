# Conferences & Meetups Using This Template

This page lists the conferences and meetups that are currently using the `quick-conf` template. It serves as a showcase for the community and helps demonstrate the template's versatility.

## Add Your Event

Are you using this template for your conference or meetup? That's fantastic!
